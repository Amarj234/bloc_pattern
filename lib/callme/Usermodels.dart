...
Address addressFromJson2(String str) => Address.fromJson(json.decode(str));
String addressToJson2(Address data) => json.encode(data.toJson());
...
class Coordinates2 {
  ...
  Coordinates2.fromJson(dynamic json) {
    lat = json['lat'];
    lng = json['lng'];
  }
  num? lat;
  num? lng;
  Coordinates2 copyWith({
    num? lat,
    num? lng,
  }) =>
      Coordinates2(
...
Hair hairFromJson(String str) => Hair.fromJson(json.decode(str));
String hairToJson(Hair data) => json.encode(data.toJson());
